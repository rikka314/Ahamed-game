...
- 当前对话重构：**C0–C7 已完成**。C6 证据为 `evaluation/phase8/c6-cli-acceptance-20260829-r5.json`；C7 本地验收为 `evaluation/phase8/c7-runtime-acceptance-20260829-r7.json`，真实对话基准为 `evaluation/phase8/c7-dialogue-live-20260829-r4/`。新 Software RC 只证明模型层离线候选已重建；目标服务器 Phase 8-B 与远程交互启用仍是后续独立发布门。
