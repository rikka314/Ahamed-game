...
- E5 发布证据工程已实现。当前权威快照为 `evaluation/phase8/e5-full-release-20260903-r2/`：20/20 本地门禁通过、生产客户端 16 文件零敏感命中、478 个 RC 文件 manifest 复验和四个外层 SHA-256 全通过；acceptance SHA-256 `540ac694d2c65f3ed8e4f2cd86c8ee841ad1f16dde9b1cee40fe0abcd0100805`，runtime manifest 文件 SHA-256 `1d59f22626c9cbe1358269e6addf2751c0f5ea9649c8bfa7e45564d7582729d4`、自哈希 `758253ac73fdd62825f28c26d9a1deaf04a5474812f51d67e34647ef8ea772ae`，tar SHA-256 `2925040e8753540c029b58199302b972f60a28751c462174269014078aaabd98`。decision 为 `incomplete`，因为 M0/B1–B5 未实施，实际仍为 5/30 病例、20/120 轨迹、30/180 黄金向量、100/600 样本、0/36 新域安全、0/60 当前病例 AI 审核、5/72 人格真实轮和 0/360 发布对话；E3/E4 最终真实观察为 `not_run`，旧审核为 `stale`。
- 当前批准范围只有第三方 OpenAI-compatible Provider + `gpt-5.6-sol`；Claude 真实验证延期且非阻塞，不存在自动 failover。
- 当前对话实现已完成 AI 主导/完整历史/诊断意图纠偏并通过全部测试与覆盖率门；v0.4 真实模型本地 smoke 已验证合理补全姓名、父母姓名、住址和昨日行程并保持一致，也验证了明确单诊断直接评分、清晰主诊断加鉴别诊断评分、多病无主次继续对话。E3 的 v0.5.0 真实运行当前为 `not_run`。旧 C6 r6、C7 runtime r10、dialogue-live r5、runtime manifest r11 和 Software RC r9 只作历史证据；E5 r2 已生成当前 dirty 源码快照，但 quality decision 为 `incomplete`。
