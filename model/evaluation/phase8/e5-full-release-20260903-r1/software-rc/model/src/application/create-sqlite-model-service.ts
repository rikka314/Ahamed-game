...
import { UnconfiguredModelProvider } from "../providers/unconfigured-model-provider.js";
...
export function createSqliteModelService(options: {
  ...
  const provider = options.provider ?? new UnconfiguredModelProvider();
