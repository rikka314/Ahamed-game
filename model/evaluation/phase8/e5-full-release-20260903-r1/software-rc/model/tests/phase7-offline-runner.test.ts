...
test("Phase 7 offline report is provider-free and opens the full benchmark for artifact-verified AI cases", () => {
  ...
  assert.equal(report.fullCandidateBenchmarkGate.status, "full_candidate_benchmark_ready");
  assert.equal(
