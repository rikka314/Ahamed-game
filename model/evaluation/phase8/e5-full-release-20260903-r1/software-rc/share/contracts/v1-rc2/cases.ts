import type { CaseIdV1, CaseVersionV1, ClientRequestIdV1, FactIdV1, GameProfileIdV1, NpcIdV1, PatientRoleIdV1, SessionIdV1, UserIdV1 } from "../v1/ids.js";
import type { SessionPhaseV1 } from "../v1/sessions.js";
import type { TestResultV1 } from "../v1/tests.js";
...
export const CASE_SUMMARY_KEYS_V1 = [
  "contractVersion",
  "sessionId",
  "caseId",
  "caseVersion",
  ...
  "allowedActions",
  "sessionPhase",
] as const satisfies readonly (keyof CaseSummaryV1)[];

export function projectCaseSummaryV1(input: CaseSummaryV1): CaseSummaryV1 {
  const output: CaseSummaryV1 = {
    contractVersion: input.contractVersion,
    sessionId: input.sessionId,
    caseId: input.caseId,
    caseVersion: input.caseVersion,
    patientNpcId: input.patientNpcId,
    patientRoleId: input.patientRoleId,
    chiefComplaint: input.chiefComplaint,
    patientDisplay: {
      displayName: input.patientDisplay.displayName,
      ...(input.patientDisplay.ageBand === undefined
        ? {}
        : { ageBand: input.patientDisplay.ageBand }),
      ...(input.patientDisplay.genderDisplay === undefined
        ? {}
        : { genderDisplay: input.patientDisplay.genderDisplay }),
      ...(input.patientDisplay.portraitAssetId === undefined
        ? {}
        : { portraitAssetId: input.patientDisplay.portraitAssetId }),
    },
