...
const publicSchema = JSON.parse(
  readFileSync("../share/schemas/v1-rc2/public-contracts.schema.json", "utf8"),
) as JsonSchemaSubset;
...
test("Phase 3 adapters emit share v1-rc2 schema-valid DTOs", () => {
  ...
  assert.equal(created.session.patientRoleId, "patient-role.public-c01");
