...
const forbiddenKeys = new Set(["answerKey", "rubric", "prompt", "systemPrompt", "hiddenFacts", "undisclosedFacts", "modelReasoning", "apiKey"]);
...
test("public schema does not define confidential fields", () => {
  const source = readFileSync(resolve("schemas/v1/public-contracts.schema.json"), "utf8");
