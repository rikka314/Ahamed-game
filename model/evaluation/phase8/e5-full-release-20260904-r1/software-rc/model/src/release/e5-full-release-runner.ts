...
function main(): void {
  ...
  try {
    ...
    const currentSourceManifestModelPath = "cases/manifest.phase6-compat.v2-rc2.json";
    ...
    const sourceManifestPath = "model/cases/manifest.phase6-compat.v2-rc2.json";
    const scoringGoldenVectorsPath =
      "model/cases/evaluation/launch-scoring-golden-vectors-v4.json";
    const newDomainSafetyPath = "model/cases/evaluation/phase7-new-domain-safety-v5.json";
