...
function dialogueQuestions(minimumTurns: number): string[] {
  const questions: string[] = [...C7_BASE_TURNS];
...
async function main(): Promise<void> {
  try {
    ...
    const contentManifest = loadCaseManifestV2(
      resolve(modelRoot, "cases/manifest.phase6-compat.v2-rc1.json"),
    );
    ...
    const reportArtifact = {
      ...
      bindings: {
        ...
        shareContractSha256: sha256File(
          resolve(modelRoot, "../share/versions/contract-v1-rc2.json"),
        ),
