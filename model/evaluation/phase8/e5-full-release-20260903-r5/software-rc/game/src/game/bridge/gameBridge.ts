import type { CaseSummaryV1, SessionIdV1 } from "@ahamed/doctor-game-share";
...
export type ClinicFlowSnapshot = {
  ...
  currentPatientRoleId: string | null;
  currentSessionId: SessionIdV1 | null;
...
type GameCommandMap = {
  ...
  "clinic.dismiss-current": { commandId: string; sessionId: SessionIdV1 };
