...
export interface AnthropicResponseSchema extends OpenAIResponseSchema {}

export interface AnthropicTransportRequest extends OpenAITransportRequest {
  schema: AnthropicResponseSchema;
}

export interface AnthropicTransportResponse extends OpenAITransportResponse {}

export interface AnthropicMessagesTransport extends OpenAIResponsesTransport {
  create(
  ...
  implements AnthropicMessagesTransport
{
  ...
  async create(
    ...
    try {
      ...
      const outputText = extractStructuredText(data.content);
